    ...
    <main className="min-h-screen bg-[#f8f5ef] text-[#21312b]">
        ...
        <div className="mx-auto max-w-6xl px-5 pb-24 pt-6 sm:px-8 lg:px-12 lg:pb-32">
          ...
          <div className="pt-10 sm:pt-14"><div className="flex justify-center pb-12 sm:pb-16"><OptimeStaticLogo variant="primary" height={112} className="items-center" /></div>
            ...
            <p className="mt-7 max-w-4xl text-xl leading-9 text-[#52645d] sm:text-2xl sm:leading-10">
              Choosing senior living has many important dimensions. Answer a few questions, and <span className="whitespace-nowrap"><span>OOmn</span><span className="relative inline-block">ı<span aria-hidden="true" className="absolute left-1/2 -translate-x-1/2 rounded-full bg-orange-500" style={{ width: "0.18em", height: "0.18em", top: "0.08em" }} /></span><span>k</span></span> will understand the case, research the options, explain what is still unknown, and help you move forward with confidence.
            </p>
      ...
      <section id="describe" className="mx-auto max-w-6xl px-5 py-24 sm:px-8 lg:px-12">
        <div className="max-w-4xl">
          ...
          <p className="mt-5 max-w-2xl text-xl leading-9 text-[#5a6d65]">Use your own words. <span className="whitespace-nowrap"><span>OOmn</span><span className="relative inline-block">ı<span aria-hidden="true" className="absolute left-1/2 -translate-x-1/2 rounded-full bg-orange-500" style={{ width: "0.18em", height: "0.18em", top: "0.08em" }} /></span><span>k</span></span> will combine the story with the answers already saved.</p>
