    ...
    <main className="min-h-screen bg-[radial-gradient(circle_at_10%_0%,#173f70_0,#071a33_34%,#030b17_100%)] px-5 py-8 text-slate-100 sm:px-10">
      <section className="mx-auto max-w-6xl space-y-6">
        ...
        <section className="grid gap-4 md:grid-cols-3">
          ...
          <article className="rounded-3xl border border-violet-400/30 bg-violet-400/10 p-6"><p className="text-xs font-bold uppercase tracking-[.18em] text-violet-300">Participating facilities only</p><p className="mt-3 text-3xl font-black">$500 Welcome Package</p><p className="mt-2 text-sm text-slate-300">Available only after registration, signed agreement, and completed onboarding. Non-participating facilities do not receive or advertise this benefit.</p></article>
        </section>
