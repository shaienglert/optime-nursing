        ...
        {!isLoading && rankedFacilities.length > 0 ? (
          <section className="mt-6 space-y-6">
            <article className="rounded-3xl border border-[#e8ddcc] bg-white p-6 shadow-[0_16px_50px_-34px_rgba(69,58,43,0.25)]">
              ...
              <h2 className="mt-2 text-xl font-semibold text-[#2f2a24]">Top matches for this search</h2>
              <p className="mt-2 text-sm text-[#5c5347]">Distance is currently disabled until real addresses are entered, so it does not affect ranking.</p>
            </article>
