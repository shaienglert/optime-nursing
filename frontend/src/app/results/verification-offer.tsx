...
export function VerificationOffer() {
  ...
  return (
    <section className="rounded-3xl border border-[#d9e3dc] bg-[linear-gradient(120deg,#f3f8f4_0%,#fffdf8_70%)] p-6 shadow-[0_16px_50px_-34px_rgba(69,58,43,0.25)]">
      <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#5f7f6b]">Before you review your top recommendations</p>
      <h2 className="mt-2 text-xl font-semibold text-[#2f2a24]">Would you like OPTIME to verify the missing details for you?</h2>
