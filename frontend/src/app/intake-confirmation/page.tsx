    ...
    <main className="min-h-screen bg-[#f6f3ed] px-4 py-10 text-[#26352f] sm:px-8">
      <section className="mx-auto max-w-5xl">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2">
          ...
          <SummaryRow label="Coverage and budget" value={[`$${state.budget.toLocaleString()} per month`, `Medicare: ${state.medicareStatus || "not applicable"}`, `Medicaid: ${state.medicaidStatus}`].join("; ")} />
