...
const NAV_LINKS = [
  { href: "/", label: "Home" },
  { href: "/assessment", label: "Find the Right Care" },
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[#d8e7e1] bg-white/92 backdrop-blur">
      <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between gap-4 px-4 sm:px-8">
        ...
        <Link href="/assessment" className="shrink-0 rounded-full bg-[#1f6f5d] px-4 py-2 text-sm font-semibold text-white transition hover:bg-[#185949]">
          Find the Right Care
        </Link>
      </div>
    </header>
