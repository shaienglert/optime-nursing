...
from audit_nevada_recommendation_source_coverage import listing_match, norm_addr, scope_records  # noqa: E402
...
def test_directory_name_alone_never_matches():
    r = record()
    assert listing_match(r, norm_addr("alpha care las vegas senior living")) is False


def test_directory_exact_normalized_address_and_zip_matches():
    r = record(address="100 W. Main Street")
    page = norm_addr("alpha care 100 west main st las vegas nv 89101")
