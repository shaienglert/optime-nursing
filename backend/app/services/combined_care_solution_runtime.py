...
def _agency_match_from_row(row: Dict[str, Any]) -> Dict[str, Any]:
    """Read a future agency-match payload without coupling to its storage implementation.

    The agency project can attach either `external_care_agency_match` or a list named
    `external_care_agency_matches` to a candidate. Only VERIFIED matches can close a MUST.
    """
