...
from app.services import decision_engine_core as _legacy
...
# Comparison is an explicit re-export; the core runner receives its prepared profile.
...
def run_patient_decision_engine(
    ...
    *, patient_needs_profile: Dict[str, Any] | None = None,
    ...
    core = _legacy.run_patient_decision_engine(
        ...
        patient_needs_profile=patient_needs_profile if patient_needs_profile is not None else build_patient_needs_profile(questionnaire_state, natural_language_query),
    )
