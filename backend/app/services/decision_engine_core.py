...
def _map_natural_language(text, needs_by_id, *, care_denials=None):
    # Compatibility entry point: interpretation rules have one owner.
    from app.services.intake_interpretation import _map_natural_language as interpret
    return interpret(text, needs_by_id, care_denials=care_denials)
...
def build_patient_needs_profile(questionnaire_state: Dict[str, Any], natural_language_query: str = "", *, care_denials=None) -> Dict[str, Any]:
    ...
    return extract_intake_facts(questionnaire_state, natural_language_query, care_denials=care_denials)["clinical_profile"]
