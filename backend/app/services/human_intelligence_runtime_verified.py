...
def build_human_intelligence_context(
    ...
    base_context = _base.build_human_intelligence_context(questionnaire_state, natural_language_query, intake_facts=facts)
    ...
    strategy_context = prepared_strategy if prepared_strategy is not None else build_living_strategy_context(questionnaire_state, natural_language_query, intake_facts=facts)
